...
private IntegerProperty actionPointsProperty; 
...
/**
 * @param healthProperty the healthProperty to set
 */
...
/**
 * @return the actionPointsProperty
 */
public IntegerProperty getActionPointsProperty( )
{
	return actionPointsProperty;
}

/**
 * @param actionPointsProperty the actionPointsProperty to set
 */
public void setActionPointsProperty( int actionPointsProperty )
{
	this.actionPointsProperty.set ( actionPointsProperty );
}
